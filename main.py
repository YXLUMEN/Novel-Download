...
from novel_model.models import GetFromBQ1, GetFromBQ2
...
def main() -> None:
    ...
    if ping_result:
        getNovelPage = GetFromBQ1(url, CONFIG['default_download_path'])
    else:
        getNovelPage = GetFromBQ2(url, CONFIG['default_download_path'])
